...
class Solver(object):
    ...
    def __init__(self):
        ...
        self.eval_subimg_loader = load_data(cfg.DATASET, 'test') if 'eval_subimg' in cfg.PHASE else None
        ...
        #num_trainable_parameters = sum([l.nelement() for l in self.model.named_parameters()])
