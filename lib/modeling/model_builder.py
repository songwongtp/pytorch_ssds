...
# ssds part
from lib.modeling.ssds import afssd_lite
from lib.modeling.ssds import attssd_lite
from lib.modeling.ssds import attfssd
from lib.modeling.ssds import attfssd_lite
...
ssds_map = {
                'afssd_lite': afssd_lite.build_afssd_lite,
                'attssd_lite': attssd_lite.build_attssd_lite,
                'attfssd': attfssd.build_attfssd,
                'attfssd_lite': attfssd_lite.build_attfssd_lite,
                'ssd': ssd.build_ssd,
...
from lib.modeling.nets import attresnet
from lib.modeling.nets import attmobilenet
networks_map = {
                    'vgg16': vgg.vgg16,
                    ...
                    'attresnet_18': attresnet.attresnet_18,
                    'attresnet_34': attresnet.attresnet_34,
                    'attresnet_50': attresnet.attresnet_50,
                    'attresnet_101': attresnet.attresnet_101,
                    ...
                    'mobilenet_att': attmobilenet.mobilenet_att,
                    'mobilenet_att_075': attmobilenet.mobilenet_att_075,
                    'mobilenet_att_050': attmobilenet.mobilenet_att_050,
                    'mobilenet_att_025': attmobilenet.mobilenet_att_025,
